...
#Thus to optimize the application its best to run this as a backend and to invoke it only when needed ,best to use ASGI server like Uvicorn to run in the backend and integrate it too .net.
#Currently this model is trained on noraml words associated with emotions, it should be further trained using dataseets which depict business instances of chats making it more accurate for our use case
#
